...
{% set job_list = dao.get_jobs_by_model_keys(identities) | pick ("active", "description", "config.model_key") %}
{
  ...
  "stats": {{ stats | tojson }}
}`,{},!0);r(j)})()},[e.package]),s?(0,a.jsx)(y,{formData:s,...t,schema:{url:"{base_url}/assets/{package}/pnl_preview.js"}}):(0,a.jsx)(g,{size:3})};export{b as default};
